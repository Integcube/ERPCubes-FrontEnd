...
import { Call, Opportunity } from '../../../opportunity.types';
...
export class CallDetailComponent implements OnInit, OnDestroy {
  ...
  selectedIsTask: any;
  scenarioslist$ = this._opportunityService.callReason$
  ...
  saveAndClose(): void {
    ...
    this._opportunityService.saveCall(this.composeForm.value, this.opportunity.opportunityId)
      .pipe(
  ...
  delete() {
    this._opportunityService.deleteCall(this.composeForm.value.callId, this.opportunity.opportunityId)
