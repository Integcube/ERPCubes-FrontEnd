...
export class CustomFacebookLoginProvider extends FacebookLoginProvider {
    ...
    signIn(signInOptions?: any): Promise<SocialUser> {
      const options = {
        ...signInOptions,
        scope: 'ads_management,pages_manage_ads,leads_retrieval,pages_manage_ads,read_insights,pages_show_list,ads_read,business_management,pages_read_engagement'
      };
