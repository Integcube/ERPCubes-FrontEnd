...
export class TasksDetailsComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    filterTagsInputKeyDown(event): void
    {
        ...
        const isTagApplied = this.task.tags.find(id => id === tag.tagId);
    ...
    updateTagTitle(tag: Tag, event): void
    {
        ...
        this._tasksService.updateTag(tag.tagId, tag)
    ...
    deleteTag(tag: Tag): void
    {
        ...
        this._tasksService.deleteTag(tag.tagId).subscribe();
    ...
    {
        // Add the tag
        this.task.tags.unshift(tag.tagId);
    ...
    {
        // Remove the tag
        this.task.tags.splice(this.task.tags.findIndex(item => item === tag.tagId), 1);
